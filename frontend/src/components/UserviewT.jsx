...
const mockTasks = [
  ...
  {
    title: "UI design",
    description: "UI design focuses on creating visually appealing and user-friendly interfaces.",
    category: "Website Redesign",
    assignee: "John Doe",
    dueDate: "2025-08-25",
    status: "To Do",
